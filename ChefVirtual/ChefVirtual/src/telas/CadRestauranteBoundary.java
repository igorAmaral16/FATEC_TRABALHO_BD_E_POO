...
public class CadRestauranteBoundary extends Application {
	...
	public void Action(Group root) {
		...
		btnCadRes.setOnAction(e -> control.inserir());
		vincular();
	}
	...
	private void layoutItens(Group root) {
		...
		Label lblmsg = new Label("E CHEF? Se cadastre e tenha acesso exclusivo!");
	...
	public void vincular() {
		...
		Bindings.bindBidirectional(txtcnpj.textProperty(), control.userProperty(), (StringConverter)converterNumber);
