...
public class CadcomumBoundary extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		stage.setScene(scn);
		stage.show();
		stage.setTitle("Cadastro Usuario Comum");
		setStage(stage);
	...
	public void  Action(Group root) {
		...
		btnCad.setOnAction(e -> control.inserir());
		vincular();
		
		btnCadRes.setOnAction(e -> control.cadastroRestaurante());
	...
	private void background(Group root) {
		...
		Text titulo = new Text(500, 150, "CADASTRO USUARIO");
	...
	private void layoutItens(Group root) {
		...
		Label lblmsg = new Label("E CHEF ou RESTAURANTE? Se cadastre e tenha acesso exclusivo!");
	...
	public void vincular() {
		...
		Bindings.bindBidirectional(control.userProperty(), txtUser.textProperty());
